...
class ModInputsalesforce_report(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("kvstore_key", title="KVStore Key Fieldname",
                                         ...
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("enable_purge", title="Purge Options",
                                         description="Choose option to purge all contents of the specified kvstore (default), purge records created by this input (multiple inputs may write to same kvstore), or  disable purge for this input.",
                                         required_on_create=False,
                                         required_on_edit=False))
        return scheme
